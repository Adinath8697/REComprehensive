...
public class RegistrationInvaliData {
	...
	public static void main(String[] args) {
				...
				driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Adinath12");
				driver.findElement(By.xpath("//input[@id='email']")).sendKeys("adikhule8697@gmailcom");
				driver.findElement(By.xpath("//input[@id='password']")).sendKeys("MH22ab1234");
